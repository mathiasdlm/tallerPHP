...
class Inmueble extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['lat', 'lon'], 'number'],
            [['cantDormitorios', 'cantBanos', 'metrosTotales', 'metrosEdificados', 'cochera', 'patio', 'enAlquiler', 'enVenta', 'idTipo', 'idCliente'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'enAlquiler' => Yii::t('app', 'En Alquiler'),
            'enVenta' => Yii::t('app', 'En Venta'),
            'precioAlquiler' => Yii::t('app', 'Precio Alquiler'),
            'precioVenta' => Yii::t('app', 'Precio Venta'),
